...
namespace DnDInventorySystem.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var game1 = new Game { Id = 1, Name = "Stormreach", Description = "Alice's campaign", CreatedByUserId = 1 };
            var game2 = new Game { Id = 2, Name = "Duskhaven",  Description = "Bob's campaign",   CreatedByUserId = 2 };
